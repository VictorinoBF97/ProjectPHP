...
<html lang="es">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="<?=APP_URL?>login">Iniciar Sesión <span class="sr-only">(current)</span></a>
      </li>
        <li class="nav-item">
      ...
      <?php else:?>
          <li class="nav-item">
            <a class="nav-link" href="<?=APP_URL?>perfil"><?=$_SESSION["userdata"]["username"]?>sads</a>
          </li>
          <li class="nav-item">
