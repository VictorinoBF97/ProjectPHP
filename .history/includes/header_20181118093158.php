...
<html lang="es">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <?php else:?>
          <li class="nav-item">
            <a class="nav-link" href="<?=APP_URL?>perfil"><?=$_SESSION["userdata"]["username"]?>Login</a>
          <li class="nav-item">
            <a class="nav-link link important" href="http://localhost/project/register">Crear cuenta</a>
          </li>
      <?php endif;?>
      </ul>
    </div>
