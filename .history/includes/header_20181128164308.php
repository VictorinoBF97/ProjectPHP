  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <?php else:?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?=BASE_URL?>create_list"><i class="fas fa-plus"></i>Añadir recambio</a>
        </li>
        </ul>
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?=BASE_URL?>profile"><i class="fas fa-user"></i> Perfil</a>
                          <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?=BASE_URL?>logout"><i class="fas fa-sign-out-alt"></i></a>
                        </div>
                    </li>
                <?php endif; ?>
      </ul>
