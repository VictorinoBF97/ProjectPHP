  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link link-important" href="http://localhost:8080/projectregister">Crear Cuenta</a>
        </li>
      <?php else:?>
          <li class="nav-item active">
            <a class="nav-link" href="<?=APP_URL?>login"><?=$_SESSION["usuario"]["username"]?><span class="sr-only"></span></a>
          </li>
          <li class="nav-item">
