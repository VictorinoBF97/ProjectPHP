    ...
    <div class="row justify-content-center mt-5">
        <div class="offset-3 col-6 pt-4 pb-4">
            ...
            <div class="form-group">
                        ...
                        <small id="nameHelp" class="form-text text-muted">Su nombre debe tener al menos 3 carácteres </small>
                        <!-- MENSAJE DE ERROR -->
            ...
            <div class="form-group">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Su apellido debe tener como mínimo 3 caracteres </small>
                        <!-- MENSAJE DE ERROR -->
