    ...
    <div class="offset-3 col-6 pt-4 pb-4">
        <form action="" method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control <?=($errors['passwordconf'])?"is-invalid":""?>" id="password_confirmation" name="password-conf" placeholder="Confirme la nueva contraseña">
                <?=validationDiv('password_conf', 'invalid-feedback')?>
            </div>
