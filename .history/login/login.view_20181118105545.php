...
<div class="container">
    <div class="offset-3 col-6 pt-4 pb-4">
        ...
        <div class="form-group">
                ...
                <small id="usernameHelp" class="form-text text-muted">El nombre de usuario debe tener Debe tener como mínimo 8 caracteres con números y letras minúsculas.</small>
                <!-- MENSAJE DE ERROR-->
