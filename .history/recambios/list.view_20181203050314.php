...
<div class="container">
    <div class="offset-3 col-6 pt-4 pb-4">
        ...
        <form action="" method="POST" novalidate>
            ...
            <button type="submit" name="saveitem" class="btn btn-primary" class="float right">Guardar</button>
            <!-- VOLVER A MIS LISTAS -->
            <?=validationDiv('login','alert')?>
            <button type="submit" name="returnlist" class="btn btn primary">Volver a Recambios</button>
        </form>
    </div>
</div>
