    ...
    <div class="offset-3 col-6 pt-4 pb-4">
        ...
        <form action="" method="POST" novalidate>
            <div class="form-group">
                <input type="text" class="form-control <?=($errors['recambios'])?"is-invalid":""?>" id="listName" name="listName" aria-describedby="itemHelp" placeholder="Introduce un nuevo nombre para la lista" value="<?=($listName['listName']??'')?>">
