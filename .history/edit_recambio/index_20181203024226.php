...
if( isset($_GET['id'])  ){
    ...
    if( isset($_POST['listName']) ) {
        ...
        $sql = "SELECT lists.id as 'list_id', lists.name as 'list_name', items.description as 'item_text' FROM zapatillas INNER JOIN lists ON zapatillas.list_id = lists.id WHERE items.id_zapatilla = $list_id LIMIT 1";
        $result = mysqli_query($db, $sql);
