...
if( isset($_GET['id'])  ){
    ...
    if( isset($_POST['listName']) ) {
        ...
        $sql = "SELECT recambios.id as 'list_id', recambios.name as 'list_name', items.description as 'item_text' FROM items INNER JOIN recambios ON items.list_id = lists.id WHERE items.id_items = $list_id LIMIT 1";
        $result = mysqli_query($db, $sql);
